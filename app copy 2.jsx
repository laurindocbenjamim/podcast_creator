...
const App = () => {
    ...
    const loadedBgImageRef = useRef(null); // NEW: Ref to store the loaded background image object
    ...
    }, [isPlaying, waveformStyle, waveformColor, backgroundColor, textOverlay]); // backgroundImage is no longer a direct dependency here
    ...
    // NEW: Effect to load background image when its URL changes
    useEffect(() => {
        if (backgroundImage) {
            const img = new Image();
