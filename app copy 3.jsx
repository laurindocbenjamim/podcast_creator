...
const App = () => {
    ...
    return (
        <div className="min-h-screen bg-zinc-900 flex flex-col items-center py-8 font-sans">
            <div className="w-full max-w-4xl bg-zinc-800 p-8 rounded-lg shadow-xl">
                ...
                <div className="mb-6 p-4 border border-zinc-700 rounded-lg">
                    <label htmlFor="audio-upload" className="block text-lg font-medium text-gray-200 mb-2">
                        1. Select Audio File
                    </label>
                    <input
                        type="file"
                    ...
                    {audioUrl && (
                        <div className="mt-4 flex items-center space-x-4">
                            ...
                            <button
                                ...
                                className="p-3 bg-blue-600 text-white rounded-md shadow-md
                ...
                <div className="mb-6 p-4 border border-zinc-700 rounded-lg">
                    ...
                    <canvas
                        ...
                        width="800"
                        height="400"
                        className="w-full h-auto bg-gray-900 rounded-md border border-zinc-600"
                    ></canvas>
                </div>

                {/* Customization Options */}
                <div className="mb-6 p-4 border border-zinc-700 rounded-lg grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label htmlFor="waveform-style" className="block text-lg font-medium text-gray-200 mb-2">
                            3. Waveform Style
                        </label>
                        <select
                            id="waveform-style"
                            ...
                            className="mt-1 block w-full pl-3 pr-10 py-2 text-base bg-zinc-700 text-gray-200 border-zinc-600 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md"
                        >
                    ...
                    <div>
                        <label htmlFor="waveform-color" className="block text-lg font-medium text-gray-200 mb-2">
                            Waveform Color
                        </label>
                        <input
                            type="color"
                            ...
                            className="mt-1 block w-full h-10 rounded-md border-zinc-600 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                        />
                    </div>
                    <div>
                        <label htmlFor="background-color" className="block text-lg font-medium text-gray-200 mb-2">
                            Background Color
                        </label>
                        <input
                            type="color"
                    ...
                    <div>
                        <label htmlFor="background-image" className="block text-lg font-medium text-gray-200 mb-2">
                    ...
                    <div className="md:col-span-2">
                        <label htmlFor="text-overlay" className="block text-lg font-medium text-gray-200 mb-2">
                            5. Text/Branding
                        </label>
                        <input
                            type="text"
                            ...
                            className="mt-1 block w-full border border-zinc-600 bg-zinc-700 text-gray-200 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                        />
                    </div>
                </div>
                    ...
                    <button
                        ...
                        className={`px-8 py-3 text-xl font-semibold rounded-lg shadow-lg
                                    ...
                                    ${isGenerating || !audioFile
                                        ? 'bg-gray-600 text-gray-300 cursor-not-allowed' // Darker disabled state
